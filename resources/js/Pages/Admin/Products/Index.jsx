            ...
            >
                <div className="flex items-center justify-center p-4 space-x-4">
                    ...
                    {previewImages.length > 1 && (
                        <button
                            onClick={prevImage}
                            className="text-white text-3xl px-3 hover:text-amber-400"
                        >
                            ‹
                        </button>
                    )}

                    {/* FIXED SMALL PREVIEW BOX */}
                    <div className="w-[320px] h-[320px] bg-stone-900 flex items-center justify-center rounded-lg border border-stone-700 overflow-hidden">
                ...
                {previewImages.length > 0 && (
                    <div className="text-center text-stone-400 text-sm pb-3">
